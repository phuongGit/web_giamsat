const PORT = 8001;                  //Đặt địa chỉ Port được mở ra để tạo ra chương trình mạng Socket Server
...
server.listen(PORT);                    // Cho socket server (chương trình mạng) lắng nghe ở port 8001
